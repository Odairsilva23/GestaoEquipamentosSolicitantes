        ...
        public override void VisualizarRegistros()
        {
            ...
            for (int i = 0; i < solicitantes.Length; i++)
            {
                Console.WriteLine(configuracaColunasTabela,
                   solicitantes[i].id, solicitantes[i].nomeSoli, solicitantes[i].email, solicitantes[i].numeroTelefone);
            }
        }
        ...
        {
            {
                ...
                Console.Write("Digite o numero do telefone sem espaços pontos ou traços: ");
                string numeroTelefone = Console.ReadLine();

                string resultadoValidacao = controladorSolicitante.
                    RegistrarSolicitante(idSelecionado, nome, email, numeroTelefone);
