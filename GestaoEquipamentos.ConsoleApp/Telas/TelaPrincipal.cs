...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    public class TelaPrincipal
    {
        ...
        public TelaPrincipal(ControladorEquipamento ctlrEquipamento, ControladorSolicitante ctlrSolicitante,
            TelaEquipamento tlEquipamento, TelaSolicitante tlSolicitante,
