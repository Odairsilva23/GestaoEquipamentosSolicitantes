...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    public class TelaChamado : TelaBase
    {
        ...
        public TelaChamado(TelaEquipamento tela, ControladorChamado controlador, TelaSolicitante TLS)
        ...
        private bool GravarChamado(int idChamadoSelecionado)
        {
            ...
            string resultadoValidacao = controladorChamado.
                RegistrarChamado(idChamadoSelecionado, idEquipamentoChamado, idSolicitante, titulo, descricao, dataAbertura);
